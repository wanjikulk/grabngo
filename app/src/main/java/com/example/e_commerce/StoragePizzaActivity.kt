...
class StoragePizzaActivity : AppCompatActivity() {
    ...
    private fun uploadImage() {
        ...
        if (name.isEmpty()){
            ...
            if(filePath != null){
                ...
                val ref = storageReference?.child("Pizzas/" + UUID.randomUUID().toString())
                progress.show()
                val uploadTask = ref?.putFile(filePath!!)!!.addOnCompleteListener{
                    ...
                    if (it.isSuccessful){
                        ref.downloadUrl.addOnSuccessListener {
                            ...
                            var ref = FirebaseDatabase.getInstance().getReference().child("Pizzas/$id")
